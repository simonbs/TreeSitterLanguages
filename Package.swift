...
let package = Package(
    ...
    products: [
        ...
        .library(name: "TreeSitterObjCQueries", targets: ["TreeSitterObjCQueries"]),
        .library(name: "TreeSitterObjCRunestone", targets: ["TreeSitterObjCRunestone"]),
    ...
    targets: [
        ...
        .target(name: "TreeSitterLaTeX", cSettings: [.headerSearchPath("src"), .unsafeFlags(["-w"])]),
        ...
        .target(name: "TreeSitterObjC", cSettings: [.headerSearchPath("src"), .unsafeFlags(["-w"])]),
        .target(name: "TreeSitterObjCQueries", resources: [.copy("queries")]),
        .target(name: "TreeSitterObjCRunestone", dependencies: ["Runestone", "TreeSitterObjC", "TreeSitterObjCQueries"]),
